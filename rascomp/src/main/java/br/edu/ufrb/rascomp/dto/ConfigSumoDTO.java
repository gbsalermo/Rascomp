...
public class ConfigSumoDTO {
    ...
    @Min(value = 0, message = "Máximo de tentativas não pode ser negativo")
    ...
    @NotNull(message = "Informe se são permitidos rounds extras")
    private Boolean permiteRoundDesempate;

    @NotNull(message = "Limite de rounds extras é obrigatório")
    @Min(value = 0, message = "Limite de rounds extras não pode ser negativo")
    private Integer maxRoundsExtras;
    ...
    public ConfigSumoDTO(ConfigSumo entity) {
        ...
        this.maxRoundsExtras = entity.getMaxRoundsExtras();
    }
}
