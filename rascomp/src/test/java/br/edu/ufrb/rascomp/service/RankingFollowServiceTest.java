...
class RankingFollowServiceTest {
    ...
    @Test
    void deveEscolherMenorTempoFinalConsiderandoPenalidade() {
        ...
        TentativaSeguidorLinha tentativa1 = tentativa(
                new BigDecimal("42.315"), 0, 1, 1);
        TentativaSeguidorLinha tentativa2 = tentativa(
                new BigDecimal("40.870"), 2, 1, 2);
        ...
        assertEquals(1L, ranking.get(0).getRegistrationId());
        assertEquals("Vespa", ranking.get(0).getRobotNome());
